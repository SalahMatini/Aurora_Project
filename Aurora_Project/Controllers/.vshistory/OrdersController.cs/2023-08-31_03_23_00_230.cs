...
namespace Aurora_Project.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            orderVM.BikesMultiselectList = new MultiSelectList(_context.Bikes, "Id", "Brand");
        ...
        public async Task<IActionResult> Create(OrderCreateUpdateViewModel orderVM)
        {
            ...
            orderVM.BikesMultiselectList = new SelectList(_context.Bikes, "Id", "Brand", orderVM.BikeIds);
