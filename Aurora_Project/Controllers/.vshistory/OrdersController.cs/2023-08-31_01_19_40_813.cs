...
namespace Aurora_Project.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            orderVM.CustomersSelectList = new SelectList(_context.Customers, "Id", "FirstName");
        ...
        public async Task<IActionResult> Create(OrderCreateUpdateViewModel orderVM)
        {
            ...
            orderVM.CustomersSelectList = new SelectList(_context.Customers, "Id", "FirstName", orderVM.CustomerId);
